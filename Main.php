...
namespace IdnoPlugins\Akismet {
	...
	class Main extends \Idno\Common\Plugin
	{
		...
		function registerEventHooks()
		{
			...
			\Idno\Core\Idno::site()->events()->addListener('annotation/save', function(\Idno\Core\Event $event)
			{
				try {
		...
		function registerPages()
		{
			...
			\Idno\Core\Idno::site()->routes()->addRoute('admin/akismet', '\IdnoPlugins\Akismet\Pages\Admin');
